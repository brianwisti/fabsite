...
class TestPages:
    def test_pages_undated(self, site):
        ...
        tpl = "<div>{{ content }}</div>"
        fabsite.make_pages(src, dst, tpl)
    ...
    def test_pages_layout_params(self, site):
        ...
        fabsite.make_pages(src, dst, tpl, title="Lorem")
    ...
    def test_pages_return_value(self, site):
        ...
        dst = os.path.join(site.site_path, "{{ slug }}.txt")
        tpl = "<div>{{ content }}</div>"
        posts = fabsite.make_pages(src, dst, tpl)
    ...
    def test_content_no_rendering(self, site):
        ...
        dst = os.path.join(site.site_path, "{{ slug }}.txt")
        tpl = "<div>{{ content }}</div>"
        fabsite.make_pages(src, dst, tpl, author="Admin")
    ...
    def test_content_rendering_via_kwargs(self, site):
        ...
        dst = os.path.join(site.site_path, "{{ slug }}.txt")
        tpl = "<div>{{ content }}</div>"
        fabsite.make_pages(src, dst, tpl, author="Admin", render="yes")
    ...
    def test_rendered_content_in_summary(self, site):
        ...
        posts = fabsite.make_pages(src, post_dst, post_layout, author="Admin")
        fabsite.make_list(posts, list_dst, list_layout, item_layout)
